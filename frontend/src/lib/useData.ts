...
export function useData<T>(
  ...
  // THE KEY FIX: fires when browser restores page from back-forward cache
  // This is exactly what happens with a 2-finger trackpad back gesture on Mac
  useEffect(() => {
    const onPageShow = (e: PageTransitionEvent) => {
      // e.persisted = true means page was restored from bfcache, not a fresh load
